...
(function (factory) {
  ...
  function buildAnimName(val) {
    return "wb-anim-" + val.effect + (val.direction ? "-" + val.direction : "");
  }
    ...
    GoogleMapsApi.addListener = function (callback) {
      ...
      if (!win["GoogleMapsApi_ScriptLoaded"]) {
        ...
        win["GoogleMapsApi_clb_fn"] = function () {
          return (win["GoogleMapsApi_ScriptReady"] = true);
        };
        var region =
  ...
  var GalleryLib = (function () {
    function GalleryLib(data) {
      ...
      this.disablePopup =
        typeof data.disablePopup === "boolean"
          ...
          : this.disablePopup;
      this.hideArrows =
        typeof data.hideArrows === "boolean"
          ? data.hideArrows
          : this.hideArrows;
      this.slideOpacity =
    ...
    GalleryLib.prototype.reset = function (callback) {
      ...
      if (this.slideshowInterval && this.images.length > 1) {
        this.slideshowTimer = setInterval(function () {
          return _this.slideshowNext(callback);
    ...
    GalleryLib.prototype.renderMap = function () {
      ...
      if (this.key) {
        GoogleMapsApi.addListener(function () {
          ...
          if (!_this.map) {
            if (!_this.mapDiv) {
              _this.mapDiv = (0, jquery_1.default)("<div>")
    ...
    GalleryLib.prototype.renderSlideshow = function () {
      ...
      larr.click(function () {
        return _this.slideshowPrev();
      });
      rarr.click(function () {
        return _this.slideshowNext();
      });
      this.reset();
      this.imageIndex = -1;
      this.slideshowNext();
    ...
    GalleryLib.prototype.renderList = function () {
      ...
      (0, jquery_1.default)(thumbdiv_in1).click(function () {
        return _this.slideBy(-_this.fullThumbWidth * 3);
      });
    ...
    GalleryLib.prototype.slideBy = function (delta, instant) {
      ...
      if (x > 0) x = 0;
      var css = { left: x + "px" };
      if (instant) div.stop(true, false).css(css);
      else div.animate(css);
    };
      ...
      img.onload = function () {
        if (_this.displayedImage) {
          ...
          _this.displayedImage.fadeOut(_this.getTransitionSpeed(), function () {
            if (_this.displayedImage) _this.displayedImage.remove();
          });
          if (caption_1) {
            caption_1.fadeOut(_this.getTransitionSpeed(), function () {
    ...
    GalleryLib.prototype.onMetaChange = function () {
      ...
      this.metaUpdateTimeout = requestAnimationFrame(function () {
        ...
        if (_this.type === "map") {
          ...
          if (
            _this.getThumbWidth() >= 100 &&
            _this.showPictureCaption !== "none"
          ) {
          ...
          var renderListImageMeta = function ($cont, fadeIn) {
            ...
            if ($caption && !$prevCaption) {
              ...
              if (opacity < 1) {
                ...
                if (fadeIn)
                  $caption.fadeTo(
                    Math.floor((1 - opacity) * _this.getTransitionSpeed()),
                    1,
                  );
                else
                  $caption.fadeOut(
                    Math.floor(opacity * _this.getTransitionSpeed()),
                    function () {
          ...
          if (_this.loadingImage) renderListImageMeta(_this.loadingImage, true);
          if (_this.type === "list") {
    ...
    GalleryLib.prototype.initImageLightBox = function (img, imageIndex) {
      ...
      if (
        (this.type === "slideshow" || this.type === "list") &&
        this.disablePopup
      )
        return;
